...
class LaneDetection:
    ...
    def _lane_line_fitting(self, img, lines, color=(0, 255, 0), thickness=12):
        r"""直线拟合
        ...
        if lines is not None:
            ...
            line_img = self.cv2AddChineseText(line_img, '未检测到车道线', (20, 20))
    ...
    def cv2AddChineseText(self, img, text, position=(1100, 20), textColor=(0, 255, 255), textSize=30):
...
def main():
    ...
    # mp4视频检测
        ...
        out = cv2.VideoWriter(args.output_path, fourcc=cv2.VideoWriter_fourcc(*'mp4v'), apiPreference=0, fps=fps,
                              frameSize=size)
